...
const Dashboard: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>Dashboard - CapitalCue</title>
        <meta name="description" content="Analyze company financials against your investment constraints" />
      </Head>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="border border-gray-200 rounded-lg p-4">
                    <h3 className="font-semibold text-gray-900 mb-2">🏗️ Infrastructure & Hardware</h3>
                    <p className="text-sm text-gray-600 mb-3">Specialized metrics for infrastructure companies</p>
                    <ul className="text-xs text-gray-600 space-y-1 mb-3">
                      <li>✓ Capital efficiency improving</li>
                      <li>✓ Unit economics positive</li>
                      <li>✓ Contracted revenue > 60%</li>
                      <li>✓ Market expansion potential</li>
                    </ul>
                    <button className="w-full border border-gray-300 text-gray-700 text-sm py-2 rounded-lg hover:bg-gray-50 transition-colors">
                      Apply Template (4 constraints)
                    </button>
                  </div>
                </div>
              </div>
